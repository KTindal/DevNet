...
if not os.path.exists('/scripts/backups/'):
    os.makedirs('/scripts/backups/')
...
with open('/scripts/host.txt') as csvfile:
        ...
        while rows >= 2:
            ...
            if ip_ping == None:
                ...
                downDeviceOutput = open("/backups/" + fileName, "a")
